        ...
        <div className="main-text">
            ...
            <div className="float-left-50">
                <div>
                    ...
                    <li><a href="/CommonsenseDomain/Task?TaskId=Artithmetic">Addition and Subtraction</a></li>
                    ...
                    <li><a href="/CommonsenseDomain/Task?TaskId=Trajectory">Predict Post-Collision Trajectory</a></li>
                    ...
                    <li><a href="/CommonsenseDomain/Task?TaskId=CollisionsToolUse">Tool Use</a></li>
                </div>
            </div>
        </div>
    );
