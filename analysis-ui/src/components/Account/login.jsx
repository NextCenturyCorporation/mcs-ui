                ...
                <div className="row justify-content-center align-items-center h-100 center-container">
                    <div className="col col-md-4 login-container">
                        <div className="login-header-logo">
                            <div className="d-flex justify-content-center"><img className="nav-brand-mcs" src={brandImage} alt=""/></div>
                            <div className="d-flex justify-content-center login-header-text">Machine Common Sense</div>
                        </div>
                        <div>
